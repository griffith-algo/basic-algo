"""Tsp Permutations example.

This file belongs to the week 3 lecture examples on graphs, backtracking, and divide-and-conquer algorithms. It uses path_distance to illustrate the main idea with a small runnable example.
"""
...
def path_distance(path):
    """Return the total distance of one travelling-salesperson tour.
