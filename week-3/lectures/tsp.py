...
This file belongs to the week 3 lecture examples on graphs, backtracking, and divide-and-conquer algorithms. It uses tsp_backtrack to illustrate the main idea with a small runnable example.
"""
...
def tsp_backtrack(distances, current_city, visited, path, current_distance, shortest_path, shortest_distance):
    ...
    """Search for the shortest travelling-salesperson tour using backtracking.

    Args:
        distances (object): The distances input used by this function.
        current_city (object): The current_city input used by this function.
        visited (list): The flags that mark which states or nodes are already visited.
        path (list): The current path being built by the algorithm.
        current_distance (object): The current_distance input used by this function.
        shortest_path (object): The shortest_path input used by this function.
        shortest_distance (object): The shortest_distance input used by this function.
