"""Selection Sort 2 example.

This file belongs to the introductory lecture examples on recursion, searching, and simple sorting. It uses draw_array, selection_sort to illustrate the main idea with a small runnable example.
"""
...
def draw_array(arr, highlighted_index=None):
    ...
    Args:
        ...
        highlighted_index (object): The highlighted_index input used by this function.
